...
Testing workflows can opt into `fn_problem_report` to persist human-held problem records, deduplicate findings, and require a verified results ledger before stage success. See [Structured problem reporting](problem-reporting.md) for configuration, permissions, pagination, and retry behavior.
