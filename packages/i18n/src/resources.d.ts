...
export default interface Resources {
  "app": {
    ...
    "chat": {
      ...
      "contextCoverage": "Conversation context",
      "contextIncluded": "Complete earlier messages included: {{count}}.",
      "contextMissing": "Unavailable referenced messages: {{count}}.",
      "contextNotes": "Source-linked working notes carried forward: {{count}}.",
      "contextNotesDeferred": "Working notes were too large to include and are available for retrieval.",
      "contextOlder": "Additional older history is available through conversation search.",
      "contextOmitted": "Earlier messages omitted from the prompt: {{count}}. The agent can retrieve them.",
      "contextRequiredDeferred": "Required messages needing retrieval: {{count}}.",
      "contextSavedNotes": "Working notes saved for later replies",
      "contextSource": "Source {{count}}",
      ...
      "recent": "Recent",
      "referenceUnavailable": "The referenced message could not be loaded.",
