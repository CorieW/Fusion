...
| `fn_problem_report` | Structured workflow-authorized problem reporting. Preflight before testing; report demonstrated findings; finish with every requestId (or explicit []). Supports paginated list/read of both problem columns. |
